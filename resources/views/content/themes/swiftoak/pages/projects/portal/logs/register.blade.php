              ...
              <div class="col-lg-6">
                <div class="card-body p-md-5 mx-md-4">
                  ...
                  <form action="{{url($links->register)}}" method="POST">
                    ...
                    <div data-mdb-input-init class="form-outline mb-4">
                      <input type="password" id="form2Example22 @error('password_confirmation') is-invalid @enderror"  
                  ...
                  <div class="d-flex align-items-center justify-content-center pb-4">
                    ...
                    <a   href="{{$links->loginview}}" data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-danger">Login</a>
                  </div>
