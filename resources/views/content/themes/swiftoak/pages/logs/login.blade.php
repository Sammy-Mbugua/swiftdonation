                        ...
                        <div class="row g-0">
                                ...
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <form action="{{ url($links->login) }}" method="POST">
                                        ...
                                        <div class="d-flex justify-content-between mb-3">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="remember"
                                                    name="remember" {{ old('remember') == '1' ? 'checked' : '' }}
                                                    value="1">
                                        ...
                                        <div class="d-flex justify-content-left gap-2 mb-3">
                                            ...
                                            <a href="{{ url('/resetpassword') }}" class="text-decoration-none">Forgot
                                                Password</a>
                                    ...
                                    <div class="d-flex align-items-center justify-content-center pb-4">
                                        ...
                                        <a href="{{ $links->registerview }}" data-mdb-button-init data-mdb-ripple-init
                            ...
                            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                                <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                                    <h4 class="mb-4 text-white">We are more than just a organization </h4>
