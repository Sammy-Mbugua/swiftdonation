	...
	<body>
		<table class="container" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td class="message">
					<h2>Dear!</h2>
					<p>We are pleased to welcome you to swiftoakdonations.com!</p>
					<p>To begin exploring, simply click on the "Confirm Email" button below:</p>
					<p>To personalize your account settings or explore password management options, navigate to the dedicated
						"Settings" section within the customer portal.</p>
					<br />
					...
					<br />
					<p>Our dedicated support team is readily available 24/7 to address any inquiries you may have. Feel free to respond
						directly to this email, or utilize our convenient live chat feature accessible within the control panel.</p>
