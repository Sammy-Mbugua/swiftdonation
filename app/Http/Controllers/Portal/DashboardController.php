...
class DashboardController extends Controller
{
    ...
    public function index(Request $request, $message = '')
    {
        ...
        $_referrer = \App\Models\User::with('referral')->where('id', $user)->first();
    ...
    public function donate(Request $request, $message = '')
    {
        ...
        // $referrer = \App\Models\Referral::with('this_user')->where('user', $user)->first();
        // $_referrer = \App\Models\User::with('referral')->where('id', $user)->first();

        // dd($_referrer->referral);
        // dd($referrer->referral->referred_by);
