...
class SubstriptionController extends Controller
{
    ...
    private $ParentRoute = "vrm/setup/subscription"; // Parent Route Name Eg. vrm/settings
    ...
    private $Action = 'vrm/setup/subscription/status'; // Multiple Entry Action
    ...
    public function index($message = '')
    {
        ...
        $data['entry_list'] = \App\Models\Cash\Package::get();

        $data['currency'] = \App\Models\Vrm\Hierarchy::where('type', 'currency')->get();
    ...
    public function store(Request $request, $action = '')
    {
        ...
        // Add Type
        $insertFrom['subscription'] = $validated['subscription'];
        $insertFrom['type'] = 'subscription';
        $insertFrom['parent'] = 0;
        $insertFrom['flag'] = 1;
    ...
    public function update(Request $request, $action = '')
    {
        ...
        //  dd($validated);
         ...
         $package_id = (array_key_exists('id', $decoded)) ? (int) $decoded['id'] : null;
        ...
        // Open Page
        return redirect('/vrm/setup/subscription')->with('message', 'Status Info was Updated successfully.');
    }
